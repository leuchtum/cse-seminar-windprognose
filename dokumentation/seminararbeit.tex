...
Während die gemessenen Daten die aktuelle Wetterlage an einigen Standorten Deutschlands beinhaltet, sind die generierten Daten eine weitere Information zu saisonalen und Tagesverlauf-abhängigen Faktoren. 
...
Von fünf Messtationen (Münsingen-Apfelstetten, Stötten, Günzburg, Laupheim und Ulm-Mähringen), welche sich in einem Radius von 
...
Die Daten umfassen die Jahre 2008 bis 2021.
...
\begin{figure}[tph]
	\begin{center}
		\includegraphics[scale = 1]{./images/pol2cart.pdf}  %%%%_visualize.pdf} %%% Das Bild existiert leider nicht !
