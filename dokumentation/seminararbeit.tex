...
\highlight{
	Soll hier noch das eigene geplante Modell erwähnt werden? Möglicherweise auch, dass das Modell von Chen et al. den neuen Ansatz von mehreren Standorten verfolgt, was ja auch das Ziel in dieser Arbeit ist.
}
